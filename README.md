...
- [add copycomp Makefile targets for component docs](https://github.com/kubernetes-sigs/reference-docs/pull/452) on [kubernetes-sigs/reference-docs](https://github.com/kubernetes-sigs/reference-docs) (2 days ago)
