...
- [Caesarsage/vertex-ai-firebase](https://github.com/Caesarsage/vertex-ai-firebase) - A full-stack AI chat application built with **Google Cloud&#39;s Vertex AI**, **Firebase**, and **Terraform**. This project demonstrates how to build a modern AI-powered web application with authentication, rate limiting, conversation persistence, and scalable  infrastructure for my Devfest workshop. (1 day ago)
...
- [microcks/microcks](https://github.com/microcks/microcks) ([1.13.1](https://github.com/microcks/microcks/releases/tag/1.13.1), 4 days ago) -
...
- [Automate KubeCon event listings ](https://github.com/kubernetes/website/pull/53519) on [kubernetes/website](https://github.com/kubernetes/website) (6 days ago)
